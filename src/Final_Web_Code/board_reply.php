...
// 3. 글 데이터 불러오기
$sql = "select b_idx, b_reply from board where b_idx = '".$_GET['b_idx']."'";
...
$sql2 = "select b_num, b_reply from board where b_num = '".$data['b_num']."' and b_reply like '".$data['b_reply']."%' order by b_reply desc limit 1";
